...
$(function () {
    ...
    if ($('#tinymce_message').length) {
        tinymce.init({
            ...
            content_style: "@import http_url('https://fonts.googleapis.com/css2?family=Pinyon%20Script:wght@900&family=Pinyon%20Script&display=swap'); body { font-family: 'Lato', sans-serif; } h1,h2,h3,h4,h5,h6 { font-family: 'Pinyon%20Script', sans-serif; }",
