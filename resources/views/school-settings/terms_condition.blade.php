      ...
      <div class="card">
        <div class="card-body">
          <div class="mb-3 d-flex">
            {{__("Public URL")}} :&nbsp;&nbsp;<a href="{{ http_url('school-settings/'.Auth::user()->school_id.'/'.str_replace('_','-',$name)) }}" target="_blank">{{ http_url('school-settings/'.Auth::user()->school_id.'/'.str_replace('_','-',$name)) }}</a>
        </div>
