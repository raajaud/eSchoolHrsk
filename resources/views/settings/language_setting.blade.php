                    ...
                    <div class="card-body">
                        <form id="formdata" class="create-form" data-success-function="formSuccessFunction" action="{{ route('language.store') }}" novalidate="novalidate" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 col-sm-12">
                                    <br>
                                    <a class="btn btn-success" href="{{ http_url('language-sample') }}">{{ __('download_sample') }}</a>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                       data-url="{{ http_url('language-list') }}" data-click-to-select="true"
    ...
    <div class="modal fade" id="editModal" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="edit-form" data-success-function="formSuccessFunction" action="{{ http_url('language') }}" novalidate="novalidate">
                    @csrf
