        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-2">
                <div class="linksWrapper usefulLinksDiv">
                    ...
                    <span><a href="{{ http_url('/#features') }}">{{ __('features') }}</a></span>
                    <span><a href="{{ http_url('/#pricing') }}">{{ __('pricing') }}</a></span>
                    <span><a href="{{ http_url('/#faq') }}">{{ __('faqs') }}</a></span>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-2">
                <div class="linksWrapper">
                    ...
                    <span>
                        <a href="{{ http_url('/#about-us') }}">
                            {{ __('about_us') }}
                        </a>
                    </span>
                    <span>
                        <a href="{{ http_url('/#contact-us') }}">
                            {{ __('contact') }}
                        </a>
                    </span>

                    <span>
                        <a href="{{ http_url('page/type/privacy-policy') }}">
                            {{ __('privacy_policy') }}
                        </a>
                    </span>

                    <span>
                        <a href="{{ http_url('page/type/terms-conditions') }}">
                            {{ __('terms_condition') }}
                        </a>
                    </span>

                    <span>
                        <a href="{{ http_url('page/type/refund-cancellation') }}">
