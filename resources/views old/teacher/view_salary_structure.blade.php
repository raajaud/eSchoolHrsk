            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ http_url('staff/payroll-setting',$user->staff->id) }}" method="post" class="edit-form-staff-payroll-setting edit-form" data-success-function="formSuccessFunction">
                        @csrf
                            <div class="row">
