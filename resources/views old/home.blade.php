    ...
    <div class="container">
        <div class="navbarWrapper">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                @foreach ($languages as $key => $language)
                                    <li><a class="dropdown-item" href="{{ http_url('set-language') . '/' . $language->code }}">{{ $language->name }}</a></li>
            ...
            <div class="loginBtnsWrapper">
                ...
                {{-- <a href="{{ http_url('school/registration') }}" class="commonBtn">{{ __('start_trial') }}</a> --}}
            </div>
        </div>
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="flex_column_start">
                                ...
                                <div class="d-flex">
                                    ...
                                    @if ($isDemoSchool == 1)
                                        <a href="{{ $demoSchoolUrl ?? http_url('/') }}" target="_blank" class="commonBtn">{{ __('demo_school') }}</a>
                                    @endif
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="row wrapper">
                            <div class="col-lg-6">
                                <form action="{{ http_url('contact') }}" method="post" role="form" class="php-email-form mb-5 create-form-with-captcha">
                                    @csrf
                                    <div class="card">
                                        <div>
