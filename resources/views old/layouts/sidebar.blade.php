...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
        {{-- dashboard --}}
        <li class="nav-item">
            <a href="{{ http_url('/dashboard') }}" class="nav-link">
                ...
                <div class="collapse" id="subject-lesson-menu">
                    <ul class="nav flex-column sub-menu">
                        @canany(['lesson-list', 'lesson-create', 'lesson-edit', 'lesson-delete'])
                            <li class="nav-item">
                                <a href="{{ http_url('lesson') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('Lesson Management')"> {{ __('create_lesson') }}</a>
                            </li>
                        @endcanany

                        @canany(['topic-list', 'topic-create', 'topic-edit', 'topic-delete'])
                            <li class="nav-item">
                                <a href="{{ http_url('lesson-topic') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('Lesson Management')"> {{ __('create_topic') }}</a>
                            </li>
                        @endcanany
                    </ul>
                </div>
        ...
        @canany(['addons-list', 'addons-create', 'addons-edit', 'addons-delete','package-list', 'package-create', 'package-edit', 'package-delete'])
            <li class="nav-item">
                <a href="{{ http_url('features') }}" class="nav-link">
        ...
        @can('subscription-view')
            <li class="nav-item">
                <a href="{{ http_url('subscriptions/report') }}" class="nav-link">
                    <i class="fa fa-puzzle-piece menu-icon"></i>
            ...
            <li class="nav-item">
                <a href="{{ http_url('subscriptions/transactions') }}" class="nav-link">
                    <i class="fa fa-money menu-icon"></i>
                ...
                <div class="collapse" id="certificate-menu">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @canany(['certificate-create', 'certificate-list','certificate-edit', 'certificate-delete'])
                            <li class="nav-item">
                                <a href="{{ http_url('certificate-template') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('ID Card - Certificate Generation')">
                        ...
                        @canany(['certificate-list'])
                            <li class="nav-item">
                                <a href="{{ http_url('certificate') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('ID Card - Certificate Generation')">
                        ...
                        @canany(['certificate-list'])
                            <li class="nav-item">
                                <a href="{{ http_url('certificate/staff-certificate') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('ID Card - Certificate Generation')">
                    ...
                    <div class="collapse" id="staff-leave-management">
                        <ul class="nav flex-column sub-menu">
                            ...
                            @can('approve-leave')
                                ...
                                <li class="nav-item">
                                    <a href="{{ http_url('leave/report') }}" class="nav-link" data-name="{{ Auth::user()->getRoleNames()[0] }}" data-access="@hasFeatureAccess('Staff Leave Management')">{{ __('leave_report') }}</a>
                                </li>
                            @endcan
                        </ul>
                    </div>
        ...
        {{-- Support --}}
        <li class="nav-item">
            <a href="{{ http_url('staff/support') }}" class="nav-link">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="settings-menu">
                    <ul class="nav flex-column sub-menu">
                        ...
                        @can('language-list')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ http_url('language') }}">
                        ...
                        {{-- @can('database-backup')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ http_url('database-backup') }}">{{ __('database_backup') }}</a>
                            </li>
                        @endcan --}}
