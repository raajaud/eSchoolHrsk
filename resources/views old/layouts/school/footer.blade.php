        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-3">
                <div class="linksWrapper usefulLinksDiv">
                    ...
                    <span><a href="{{ http_url('/') }}">{{ __('home') }}</a></span>
                    <span><a href="{{ http_url('school/about-us') }}">{{ __('about_us') }}</a></span>
                    <span><a href="{{ http_url('school/photos') }}">{{ __('photos') }}</a></span>
                    <span><a href="{{ http_url('school/videos') }}">{{ __('videos') }}</a></span>
                    <span><a href="{{ http_url('school/contact-us') }}">{{ __('contact_us') }}</a></span>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-6 col-lg-2">
                <div class="linksWrapper">
                    ...
                    <span>
                        <a href="{{ http_url('login') }}"> {{ __('admin_login') }}</a>
                    </span>
                    <span>
                        <a href="{{ http_url('school/terms-conditions') }}">{{ __('terms_condition') }}</a>
                    </span>
                    <span>
                        <a href="{{ http_url('school/privacy-policy') }}"> {{ __('privacy_policy') }}</a>
                    </span>

                    <span>
                        <a href="{{ http_url('school/refund-cancellation-policy') }}"> {{ __('refund_cancellation') }}</a>
                    </span>
                </div>
            </div>
