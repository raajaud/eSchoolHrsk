            ...
            <div class="menuListWrapper">
                <ul class="listItems">
                    ...
                    (isset($schoolSettings['our_mission_status']) && $schoolSettings['our_mission_status'] == 1))
                        <li>
                            <a href="{{ http_url('school/about-us') }}">{{ __('about_us') }}</a>
                        </li>
                    @endif
                        ...
                        <li>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <li>
                                        <a class="dropdown-item" href="{{ http_url('school/photos') }}">{{ __('photos') }}</a>
                                    </li>
                                    <hr />
                                    <li>
                                        <a class="dropdown-item" href="{{ http_url('school/videos') }}">{{ __('videos') }}</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                    ...
                    @if(isset($schoolSettings['faqs_status']) && $schoolSettings['faqs_status'] == 1 )
                        <li>
                            <a href="{{ http_url('/#faqs') }}">{{ __('faqs') }}</a>
                        </li>
                    @endif
                    @if(isset($schoolSettings['contact_us_status']) && $schoolSettings['contact_us_status'] == 1 )
                        <li>
                            <a href="{{ http_url('school/contact-us') }}">{{ __('contact_us') }}</a>
                        </li>
                    @endif
                </ul>
                <div class="hamburg">
                    ...
                    @if (isset($schoolSettings['gallery_status']) && $schoolSettings['gallery_status'] == 1)
                        <li>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <li>
                                        <a class="dropdown-item" href="{{ http_url('school/photos') }}">{{ __('photos') }}s</a>
                                    </li>
                                    <hr />
                                    <li>
                                        <a class="dropdown-item" href="{{ http_url('school/videos') }}">{{ __('videos') }}</a>
