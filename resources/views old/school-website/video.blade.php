...
<div class="breadcrumb">
    <div class="container">
        <div class="contentWrapper">
            ...
            <span>
                <a href="{{ http_url('/') }}" class="home">Home</a>
    ...
    setInterval(function ()
    {
        if ($(window).scrollTop() >= $(document).height() - $(window).height() - dist && !loading && count < maxCount)
        {
            ...
            @foreach($galleries as $row)
                ...
                $("#waterfall").append("<li><div class='video1 videos' style='height:" + height + "px'> <a href='{{ http_url('school/videos',$row->id) }}'> <div class='detailArr'> <img src='{{ asset('assets/school/images/videoPlayIcon.png') }}' alt=''> <span>{{ $row->title }}</span> </div> <img style='height:" + height + "px;width: 100%;' src='{{ $row->thumbnail }}' alt=''> </a> </div></li>");
