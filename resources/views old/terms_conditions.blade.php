        ...
        <div class="navbarWrapper">
            ...
            <div class="menuListWrapper">
                <ul class="listItems">
                    ...
                    <li>
                        <a href="{{ http_url('/#features') }}">{{ __('features') }}</a>
                    </li>
                    <li>
                        <a href="{{ http_url('/#about-us') }}">{{ __('about_us') }}</a>
                    </li>
                    <li>
                        <a href="{{ http_url('/#pricing') }}">{{ __('pricing') }}</a>
                    </li>
                    @if (count($faqs))
                        <li>
                            <a href="{{ http_url('/#faq') }}">{{ __('faqs') }}</a>
                        </li>
                    @endif
                    <li>
                        <a href="{{ http_url('/#contact-us') }}">{{ __('contact') }}</a>
                    </li>
                    @if (count($guidances))
                        <li>
                            <div class="dropdown">
