                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="alert alert-danger" role="alert">
                                ...
                                <li class="mt-2">
                                    ...
                                    <a href="{{ http_url('users/status') }}">{{ __('click here') }}.</a>
                                </li>
                                ...
                                @if ($prepiad_upcoming_plan && $prepiad_upcoming_plan->package->type == 0 && !$check_payment)
                                    ...
                                    @if ($paymentConfiguration && $paymentConfiguration->payment_method == 'Stripe')
                                        ...
                                        {{ __('We kindly request that you make the necessary payment for the upcoming prepaid plan to avoid any interruptions in service') }}
                                            <a href="{{ http_url('subscriptions/pay-prepaid-upcoming-plan', $prepiad_upcoming_plan->package_id) . '/type/' . $prepiad_upcoming_plan_type . '/subscription/' . $prepiad_upcoming_plan->id }}">{{ __('click_here_to_pay') }}</a>
                                        </li>
                                    @else
                                        <form action="{{ http_url('subscriptions/razorpay') }}" class="razorpay-form" method="POST">
                                            @csrf
                ...
                <div class="card">
                    <div class="card-body custom-card-body">
                        <div class="d-flex flex-row flex-wrap">
                            ...
                            <img class="ml-auto" src="{{ http_url('images/teachers.svg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body custom-card-body">
                        <div class="d-flex flex-row flex-wrap">
                            ...
                            <img class="ml-auto" src="{{ http_url('images/students.svg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body custom-card-body">
                        <div class="d-flex flex-row flex-wrap">
                            ...
                            <img class="ml-auto" src="{{ http_url('images/guardians.svg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body custom-card-body">
                        <div class="d-flex flex-row flex-wrap">
                            ...
                            <img class="ml-auto" src="{{ http_url('images/classes.svg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body custom-card-body">
                        <div class="d-flex flex-row flex-wrap">
                            ...
                            <img class="ml-auto" src="{{ http_url('images/stream.svg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body custom-card-body">
                    <div class="d-flex flex-row flex-wrap">
                        ...
                        <img class="ml-auto" src="{{ http_url('images/total-schools.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body custom-card-body">
                    <div class="d-flex flex-row flex-wrap">
                        ...
                        <img class="ml-auto" src="{{ http_url('images/active-schools.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body custom-card-body">
                    <div class="d-flex flex-row flex-wrap">
                        ...
                        <img class="ml-auto" src="{{ http_url('images/inactive-schools.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body custom-card-body">
                    <div class="d-flex flex-row flex-wrap">
                        ...
                        <img class="ml-auto" src="{{ http_url('images/package.svg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
