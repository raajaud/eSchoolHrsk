        ...
        <div class="row">
            ...
            <div style="position: relative">
                ...
                <div class="design" id="draggableElements">
                    ...
                    {{-- User image --}}
                    <img id="item_user_image" class="draggableItem" {!! $style['user_image'] ?? '' !!} src="{{ http_url('assets/dummy_logo.jpg') }}" height="{{ $certificateTemplate->image_size }}" width="{{ $certificateTemplate->image_size }}" alt="user_image">
