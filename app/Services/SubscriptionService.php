        ...
        try {
            ...
            curl_setopt_array($ch, [
                ...
                CURLOPT_POSTFIELDS => http_build_query([
                    ...
                    'mode' => 'payment',
                    'success_url' => http_url('subscriptions/payment/success') . '/{CHECKOUT_SESSION_ID}' . '/' . $subscriptionBill_id . '/' . $package_id . '/' . $type . '/' . $subscription_id . '/' . $isCurrentPlan,
                    'cancel_url' => http_url('subscriptions/payment/cancel') . '/' . $subscriptionBill_id,
    ...
    public function paystack_payment($subscriptionBill_id = null, $package_id = null, $type = null, $subscription_id = null, $isCurrentPlan = null)
    {
        try {
            ...
            $data = [
                ...
                'currency' => $currency,
                'redirect_url' => http_url('subscriptions/payment/success') . '/{CHECKOUT_SESSION_ID}' . '/' . $subscriptionBill_id . '/' . $package_id . '/' . $type . '/' . $subscription_id . '/' . $isCurrentPlan,
                'callback_url' => http_url('subscriptions/history'),
                'metadata' => [
    ...
    public function flutterwave_payment($subscriptionBill_id = null, $package_id = null, $type = null, $subscription_id = null, $isCurrentPlan = null)
    {
        try {
            ...
            $request = [
                ...
                'redirect_url' => http_url('subscriptions/history'),
                'cancel_url' => http_url('subscriptions/payment/cancel') . '/' . $subscriptionBill_id,
            ];
        ...
        try {
            ...
            if($paymentConfiguration->payment_method == 'Stripe') {
                ...
                $session = StripeSession::create([
                    ...
                    'mode'        => 'payment',
                    'success_url' => http_url('addons/payment/success') . '/{CHECKOUT_SESSION_ID}' . '/' . $addonSubscriptionId,
                    'cancel_url'  => http_url('addons/payment/cancel'),
                ]);
            ...
            if($paymentConfiguration->payment_method == 'Flutterwave') {
                ...
                $data = [
                    ...
                    'redirect_url' => http_url('addons/payment/success'),
                ];
